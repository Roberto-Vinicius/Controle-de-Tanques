...
protected:
    ...
    const SupState& lastState() const
    {
        return last_S;
    }
    ...
    void setV1Open(bool Open)
    {
        setValvOpen(true,Open);
    }
    // Fixa o estado da valvula 2: aberta (true) ou fechada (false)
    void setV2Open(bool Open)
    {
        setValvOpen(false,Open);
    }
    ...
    void setTimeRefresh(int T)
    {
        if (T>=10 && T<=200) timeRefresh=T;
    }
